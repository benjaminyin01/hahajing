...
type Kademlia2HelloRespMsg struct {
	contactID ID
	ip        uint32
	udpPort   uint16
	version   uint8
...
func (m *Kademlia2HelloRespMsg) set(pPacket *Packet) bool {
	// from packet
	m.ip = pPacket.ip
...
func (m *Kademlia2RespMsg) set(pPacket *Packet) bool {
	// from packet
	m.ip = pPacket.ip
	m.udpPort = pPacket.port
	m.verifyKey = pPacket.senderVerifyKey
...
type Kademlia2SearchRespMsg struct {
	// From contact who respond this message
	ip        uint32
	udpPort   uint16
	verifyKey uint32
...
func (m *Kademlia2SearchRespMsg) set(pPacket *Packet) bool {
	// from packet
	m.ip = pPacket.ip
	m.udpPort = pPacket.port
	m.verifyKey = pPacket.senderVerifyKey
...
func (m *Kademlia2SearchRespMsg) setFiles(bi *ByteIO) bool {
	if !bi.check(2) {
		return false
	}
...
func (m *Kademlia2SearchRespMsg) setFileSize(pFileStruct *Ed2kFileStruct, pTag *Tag) {
...
func (m *Kademlia2SearchRespMsg) setFileParams(pFileStruct *Ed2kFileStruct, tags []*Tag) {
